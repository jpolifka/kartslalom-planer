...
> wider und wird nicht mehr aktualisiert. Insbesondere die Hosting-/
> Deployment-Annahmen (Vercel/Railway/Fly.io, Supabase Cloud in Frankfurt)
> sind überholt — Produktion läuft inzwischen auf einem self-hosted
> Supabase-Stack auf eigener Infrastruktur, siehe
...
> historischer Datensatz für vergangene Entscheidungen belassen, nicht als
