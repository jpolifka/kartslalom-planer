## 1. Neues Hindernis starten

Beim Anlegen eines neuen Hindernisses fragt der Editor, womit du starten möchtest: **leer**, mit einer **Standard-Formation aus der Bibliothek** (wird dupliziert) oder — wenn du angemeldet bist — mit einem **eigenen, bereits gespeicherten Hindernis** (ebenfalls als Duplikat).

Je nach Zugriffsrecht zeigt die Kopfzeile beim Bearbeiten einen Status:
