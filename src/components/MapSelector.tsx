...
export default function MapSelector({
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 10, alignItems: "center", flexWrap: "wrap" }}>
        ...
        {drawMode === "poly" && drawnPts.length >= 3 && (
          <button
            ...
            style={{ ...btnStyle, borderColor: "#0284c7", color: "#0284c7", fontWeight: 700 }}
          >
            Polygon schliessen
          </button>
        )}
      ...
      {/* Mode hint */}
      {drawMode === "rect" && (
        <div style={{ fontSize: 12, color: "#0284c7", marginBottom: 6 }}>
...
const activeBtnStyle: React.CSSProperties = {
  border: "2px solid #0284c7", background: "#e0f2fe", color: "#0284c7", fontWeight: 700,
};
