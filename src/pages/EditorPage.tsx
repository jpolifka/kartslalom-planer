...
function ImprintContent() {
  ...
  return (
    <div>
      ...
      <h3 style={{ margin: "26px 0 0", fontSize: 16, fontWeight: 800, color: "#0f172a" }}>
      ...
      <HelpSection title="6. Lokale Verarbeitung von Streckendaten">
        Die Erstellung, Bearbeitung und der Export von Streckenplänen erfolgen
        ausschließlich lokal im Browser des Nutzers.
        <p style={{ margin: "6px 0" }}>
          Die im Streckenplaner eingegebenen Daten werden nicht an den Betreiber
          übermittelt, nicht dauerhaft gespeichert und nicht ausgewertet.
        </p>
        <p style={{ margin: "6px 0 0" }}>
          Exportierte SVG- oder PDF-Dateien werden direkt auf dem Gerät des
          Nutzers erzeugt.
        </p>
      </HelpSection>

      <HelpSection title="7. Kontaktaufnahme per E-Mail">
      ...
      <HelpSection title="8. Ihre Rechte">
      ...
      <HelpSection title="9. Beschwerderecht bei einer Aufsichtsbehörde">
      ...
      <HelpSection title="10. Änderungen dieser Datenschutzerklärung">
