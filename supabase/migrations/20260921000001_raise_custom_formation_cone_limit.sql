...
-- All rights reserved.
--
-- Cone-Limit pro Custom-Formation von 40 auf 100 angehoben.
--
-- Anlass: Speichern grösserer Hindernisse scheiterte mit HTTP 400
-- (`too_many_cones`), weil create_/update_/admin_update_custom_formation
-- bei > 40 Cones ablehnten. Der Abuse-Schutz bleibt bestehen, nur die
-- Obergrenze ist realistischer. Der Rest der Funktionen ist unverändert;
-- Grants bleiben durch CREATE OR REPLACE erhalten (kein erneutes GRANT/REVOKE).
--
-- Betrifft: create_custom_formation, update_custom_formation,
--           admin_update_custom_formation (Stand: 20260701000008).
-- Hinweis: duplicate_custom_formation kopiert nur bestehende Formationen und
-- prüft kein Cone-Limit — hier nichts zu ändern.
